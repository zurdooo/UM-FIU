...
public class MatrixTester {
	public static void main(String[] args) {
		...
		/*
		 * Note that the print will not be correct until you have implemented the
		 * toString method. This is just one example of a test of making sure your
		 * constructor is working You should write more test and experiment with various
		 * constructor cases
		 */
